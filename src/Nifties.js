...
class Nifties extends Component {
  ...
  render() {
    ...
    return (
      ...
      <a href={"https://twitter.com/intent/tweet?text="+encodeURI("I crafted "+tokensOfOwner.length+" Nifties to vote, \"Yes 👁️ in Nifties\"")+"&hashtags=NiftiesVsNfties&url="+encodeURI("https://nifties.io")} >
